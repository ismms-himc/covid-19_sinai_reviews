**Title of the article:** SARS-CoV-2 launches a unique transcriptional
signature from in vitro, ex vivo, and in vivo systems

**Keywords:** host cellular response, host-pathogen interaction, type I
interferon, type III interferon, inflammation, RNA-seq, comparative
analysis

**Summary:** Given the high mortality rate of SARS-CoV-2 relative to
...
**Limitations:** While these results are promising, there are several
...
**Importance and implications:** This paper describes potentially unique
...
**Disclosure:** The reviewers are also researchers at the Icahn School
